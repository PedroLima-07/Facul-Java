...
public class Ac2Final2 {
    public static void main(String[] args) {
        ...
        while (i < tamanhoTurma) {
            ...
            // Pergunta se deseja continuar apenas se ainda há espaço na turma
            if (i < tamanhoTurma) {
                do {
        ...
        for (int j = 0; j < i; j++) {
            System.out.println(
                    (j + 1) + "º " + nomeAlunos[j] + " - Média: " + mediaAlunos[j] + " - Situação: " + alunoStatus[j]);
        }

        // Somente mostra estatísticas se turma estiver completa
        if (i == tamanhoTurma) {
